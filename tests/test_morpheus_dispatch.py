...
from morpheus.lib import projectdir, memory, highwater, spool
import morpheus.worker as worker
...
class DispatchTest(TempHomeTest):
    def _env(self):
        ...
        return {
            ...
            "CLAUDE_MORPHEUS_HOME": os.environ["CLAUDE_MORPHEUS_HOME"],
        }
    ...
    def test_session_start_emits_digest(self):
        ...
        self.assertIn("Morpheus recall", ctx)
