...
from engines.base import get_engine  # noqa: E402
from lib import config, highwater, memory, projectdir, spool, transcript  # noqa: E402
from lib.lock import FileLock  # noqa: E402
...
def _log(msg: str) -> None:
    try:
        projectdir.dreaming_home().mkdir(parents=True, exist_ok=True)
