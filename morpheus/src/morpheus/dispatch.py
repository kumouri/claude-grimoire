...
from morpheus.lib import config, digest, projectdir, spool, transcript  # noqa: E402
...
def spawn_worker() -> None:
    if os.environ.get("CLAUDE_MORPHEUS_NOSPAWN") == "1":
        return
...
def handle_dream_trigger(data: dict, cfg: dict) -> None:
    ...
    if not forced:
        try:
            from morpheus.lib import highwater
