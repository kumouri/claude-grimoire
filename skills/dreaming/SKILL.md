...
# Dreaming — session memory consolidation

This skill performs the same consolidation the automatic dreaming hooks do, but in-context (you
...
associations. See `docs/dreaming/architecture.md` for how the automatic pipeline uses this same
two-pass model.
